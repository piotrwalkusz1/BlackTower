...
public static class SpellRepository
{
    ...
    public static void LoadSpellsActions()
    {
        GetSpellById(0).SetSpellAction(SpellActionSmokeCloud);
    }
    ...
    #region SpellsActions

    private static void SpellActionSmokeCloud(ISpellCaster caster, params ISpellCastOption[] options)
    {
        SceneBuilder.CreateVisualObject(VisualObjectType.SmokeCloud, caster.Position, caster.Rotation);
    }
